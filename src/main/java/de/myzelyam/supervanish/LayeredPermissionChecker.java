...
public class LayeredPermissionChecker {
    ...
    /**
     * @return TRUE if sender has *permission* to use /sv on, else FALSE; TRUE
     *         doesn't mean that sender can actually use /sv on
     */
    public boolean hasPermissionToVanish(CommandSender sender) {

        if (settings.getBoolean("IndicationFeatures.LayeredPermissions.LayeredSeeAndUsePermissions", false)) {
            ...
            if (sender instanceof Player)
                ...
                permissionLevel = getLayeredPermissionLevel(sender, "use");
    ...
    public int getLayeredPermissionLevel(CommandSender sender, String permission) {
        ...
        boolean enableSeePermission = settings.getBoolean("IndicationFeatures.LayeredPermissions.EnableSeePermission",
                true);
